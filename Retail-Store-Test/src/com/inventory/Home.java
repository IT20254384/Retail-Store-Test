...
public class Home extends JFrame {
	...
	public Home() {
		...
		btn_userManager.setFont(new Font("Segoe UI", Font.PLAIN, 28));
		btn_userManager.setBounds(30, 191, 406, 125);
		btn_userManager.setIcon(resize(new ImageIcon(this.getClass().getResource("/img_Logo.png")),label_Main_logo.getWidth(), label_Main_logo.getHeight()));
		contentPane.add(btn_userManager);
		
		JButton btnNewButton_1 = new JButton("User Manager");
		btnNewButton_1.setFont(new Font("Segoe UI", Font.PLAIN, 28));
		btnNewButton_1.setBounds(532, 191, 406, 125);
		btnNewButton_1.setIcon(resize(new ImageIcon(this.getClass().getResource("/img_Logo.png")),label_Main_logo.getWidth(), label_Main_logo.getHeight()));
